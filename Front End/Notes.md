# JS, HTML and CSS  
* Javascript - a programmning language that is used for front end and back end development to create interacive and appealing web applications. It controls the functionality of a application.  
...
* HTML (Hypertext Markup Language) - the structure(skeleton) of a website. It consists of pieces of code called 'elements' that represent what the application will look like such as having a header, image, link, etc.  
    ...
    - Elements such as header, main, and list items are all used in the image above to structure the website  
...
## React.js
* React - a JS library used to create single page web applications and UIs by using components.
